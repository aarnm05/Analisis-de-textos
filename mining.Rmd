...
Our_bigram_count[1:15,] %>% ggplot(aes(x = reorder(bigram,n) ,y = n))+
  geom_point(color = "blue")+
  geom_segment(
...
+Bigramas
Añadir token "no" antes de expresiones de negación  falta (no tira bigramas con no)
Falta hacer graficos para Our_bigram_count y bigramas_con_no


+Red de correlaciones
Si da tiempo armar una de esos (listo)
